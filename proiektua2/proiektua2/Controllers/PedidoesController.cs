...
namespace proiektua2.Controllers
{
    public class PedidoesController : Controller
    {
        ...
        public PedidoesController(AdminDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.BezeroaEskaera.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("idPedido,idUsuario,fecha")] Pedido pedido)
        {
